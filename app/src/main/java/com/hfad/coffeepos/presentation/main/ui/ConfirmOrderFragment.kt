...
class ConfirmOrderFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val order = arguments?.getSerializable("str") as HashMap<Dish, String>
    ...
    private fun getTotalCost(map: HashMap<Dish, String>): Double {
        var totalCost = 0.0
        map.forEach { (dish,value) ->
            totalCost += dish.cost?.times(value.toInt()) ?: 0.0
        }
        return totalCost
    }
